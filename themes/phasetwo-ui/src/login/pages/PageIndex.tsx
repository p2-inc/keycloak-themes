...
const Page_email_confirmation_error = lazy(() => import("./extensions/magic-link/email-confirmation-error"));
const Page_view_email = lazy(() => import("./extensions/magic-link/view-email"));
const Page_view_email_continuation = lazy(() => import("./extensions/magic-link/view-email-continuation"));

// Extension pages — orgs
const Page_invitations = lazy(() => import("./extensions/orgs/invitations"));
const Page_ext_select_organization = lazy(() => import("./extensions/orgs/ext-select-organization"));
const Page_login_select_idp = lazy(() => import("./extensions/orgs/login-select-idp"));
const Page_hidpd_select_idp = lazy(() => import("./extensions/orgs/hidpd-select-idp"));
const Page_idp_validation = lazy(() => import("./extensions/orgs/idp-validation"));

// Extension pages — recaptcha
